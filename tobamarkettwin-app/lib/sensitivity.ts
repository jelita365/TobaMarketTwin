import { DecisionResult, ProductConfiguration } from '@/types';
import { computeDecisionResults, SCENARIOS, rankByDecisionScore } from './decision';
 ...
 * Does not imply empirical robustness; it only shows how the deterministic
 * decision rule responds to different prototype weight choices.
 */
