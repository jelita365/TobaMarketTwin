...
import { Decision, HumanEvaluation } from '@/shared/domain';
...
function createManualEvaluation(
    configId: string,
...
export default function CustomerEvaluationPage({ params }: PageProps<'/customer-evaluation/[experimentId]'>) {
    ...
    const handleSubmit = () => {
        ...
        submitHumanEvaluation(experimentId, config.id, createManualEvaluation(config.id, scores, decision, comment));
        setSubmitted(true);
    };
