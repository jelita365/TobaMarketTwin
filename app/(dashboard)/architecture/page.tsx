...
const MODULES = [
    { path: 'lib/configurations', desc: 'Generates the full cartesian product of configuration options' },
    { path: 'lib/constraints', desc: 'Filters infeasible configurations before Customer Twin evaluation' },
    { path: 'lib/customerTwin (aiTwin.ts)', desc: 'CustomerTwinEngine.evaluate() — deterministic mock, swappable for a real LLM' },
    { path: 'lib/sustainability', desc: 'Prototype Sustainability Index — attribute-based, not LCA' },
    { path: 'lib/calibration', desc: 'Cross-configuration Spearman ρ, MAE, decision agreement; gated on sample size' },
    { path: 'lib/decision', desc: 'Weighted Sum Model, Decision Trace' },
    { path: 'lib/sensitivity', desc: 'Runs the decision rule under three weighting scenarios' },
    { path: 'lib/whatif', desc: 'Recomputes a hypothetical configuration on the fly' },
];
